...
Feature: Hello World API
  ...
  @hello-world-api @api-platform @regression-tests
  Scenario: Calling Hello World endpoint requesting XML works
    Given I have a valid XML accept header
    When I make a call to the get hello world endpoint
    Then I get a successful hello XML response with the message Hello World

  @hello-world-api @api-platform @regression-tests
  Scenario: Calling Hello Application endpoint requesting XML works
    Given I have a valid server token
    And I have a valid XML accept header
    When I make a call to the get hello application endpoint
    Then I get a successful hello XML response with the message Hello Application

  @hello-world-api @api-platform @regression-tests
  Scenario: Calling Hello User endpoint requesting XML works
    Given I have a valid bearer token for scope "hello"
    And I have a valid XML accept header
    When I make a call to the get hello user endpoint
    Then I get a successful hello XML response with the message Hello User
